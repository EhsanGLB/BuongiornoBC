# BuongiornoBC
This is a boundary condition for Buongiorno model on walls written based on foam-extend-4.1.
...
```bash
git clone https://github.com/EhsanGLB/BuongiornoBC.git
cd BuongiornoBC/BuongiornoBC
wmake libso
cd ../case
```
...
## Activation
Add "libBuongiornoBC.so" to case/system/controlDict
